  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between gap-4 mb-6">
        <div>
          <p className="font-mono text-[11px] uppercase tracking-[0.06em] text-[#6B7A8F] mb-2">Cartera</p>
          <h1 className="text-[22px] font-semibold tracking-tight text-[#0E1A2B] mb-1">Deudores</h1>
          <p className="text-[13.5px] text-[#6B7A8F]">{list.length} empresas con facturas en gestión activa.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-7">
        ...
        <MetricCard
          ...
          label="Mora promedio"
          value={`${moraPromedio} <span class='text-[#8E9BAE] font-medium text-[16px]'>días</span>`}
        ...
        <MetricCard
          ...
          value={`76<span class='text-[#8E9BAE] font-medium text-[16px]'>%</span>`}
